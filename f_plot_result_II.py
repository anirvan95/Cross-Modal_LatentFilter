...
wocm_outputs = [np.concatenate([y_vis_n0_c0_wocm, y_tac_n0_c0_wocm], axis=-1),
                    np.concatenate([y_vis_n1_c0_wocm, y_tac_n1_c0_wocm], axis=-1),
                    np.concatenate([y_vis_n2_c0_wocm, y_tac_n2_c0_wocm], axis=-1),
                    np.concatenate([y_vis_n0_c1_wocm, y_tac_n0_c1_wocm], axis=-1),
                    np.concatenate([y_vis_n0_c2_wocm, y_tac_n0_c2_wocm], axis=-1)]
